...
<template>
    ...
    <div class="mx-auto flex w-full max-w-4xl flex-col gap-6 p-4 md:p-6">
        <PageHeader :icon="Users" title="Team" description="Invite staff and control what they can do" />
        ...
        <form class="rounded-2xl border bg-card p-5 shadow-sm md:p-6" @submit.prevent="add">
            <h2 class="mb-4 flex items-center gap-2 text-sm font-semibold text-muted-foreground">
                <Plus class="size-4 text-orange-500" /> Add a team member
            </h2>
            <div class="grid gap-4 sm:grid-cols-3">
                <div class="grid gap-2">
                    <Label for="member_name">Name <span class="font-normal text-muted-foreground">(optional)</span></Label>
            ...
            <p class="mt-3 text-xs text-muted-foreground">{{ roleInfo[form.role].desc }}. They'll log in with their mobile number & OTP — no password needed.</p>
        ...
        <div class="overflow-hidden rounded-2xl border bg-card shadow-sm">
            <div class="border-b px-6 py-4">
                <h2 class="flex items-center gap-2 text-sm font-semibold"><ShieldCheck class="size-4 text-orange-500" /> Your team · roles</h2>
            </div>
            ...
            <div v-else class="px-6 py-14 text-center">
                ...
                <p class="mt-4 font-medium">No team members yet</p>
                <p class="mt-1 text-sm text-muted-foreground">Add your staff by mobile number — they'll see your jobs and applicants based on their role.</p>
            </div>
        </div>
    </div>
</template>
